...
import com.example.medbuddy.patient.PatientDashboard
...
class AppointmentCreate : AppCompatActivity() {
            ...
            call.enqueue(object : Callback<String> {
                override fun onResponse(call: Call<String>, response: Response<String>) {
                    if (response.isSuccessful) {
                        val intent = Intent(applicationContext, PatientAppointments::class.java)
                        startActivity(intent)
                        Toast.makeText(
                            applicationContext,
